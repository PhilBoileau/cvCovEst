...
risk.  It is also one of the only estimators to produce a positive-definite
estimate, along with the linear shrinkage estimator, although the linear
shrinkage estiator yields a better conditioned estimate in this case.  We can
take a closer look at the estimator's performance based on other possible
