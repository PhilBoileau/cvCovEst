...
To address this question, we offer just that: a general, cross-validation-based
framework for covariance matrix estimator selection in high dimensions. The
...
conditional cross-validated risk's to identify the optimal selection. The loss
