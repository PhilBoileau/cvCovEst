...
`cvCovEst` mplements an efficient cross-validated approach to covariance matrix
estimation in high-dimensional settings. A general methodology for data
adaptively identifying (via cross-validation) the optimal estimator of the
covariance matrix from a set of pre-specified candidates is provided.
Diagnostic tools are also provided for assessing the quality of covariance
matrix estimators.
